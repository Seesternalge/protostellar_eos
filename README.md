...
These four quantities are all tabulated as a function of temperature and temperature; by default from log10(T_min [K]) = 0.5 to log10(T_max [K]) = 6.0 in steps of log(DeltaT [K]) = 0.01 and from log10(Rho [g cm^(-3)]) = -22.0 to log10(Rho [g cm^(-3)]) = 1.0 in steps of log10(DeltaRho [g cm^(-3)]) = 0.05.
